...
public class CentrifugalExtractorTileEntity extends MachineCrafterTileEntity {
	...
	public HOEMachineIO getSuperIO() {
		return (HOEMachineCrafterIO) ChemLab.getIOCollection().getHOEIO("CentrifugalExtractorIO");
	}
