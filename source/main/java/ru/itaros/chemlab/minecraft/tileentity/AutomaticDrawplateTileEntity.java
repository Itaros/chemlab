...
public class AutomaticDrawplateTileEntity extends MachineCrafterTileEntity {
	...
	public HOEMachineIO getSuperIO() {
		return (HOEMachineCrafterIO) ChemLab.getIOCollection().getHOEIO("AutomaticDrawplateIO");
	}
