...
//		
//		
//		this.addHOESlotToContainer(new UniversalSlot((IUniversalInventory) tile,-1,48+32,37));
//		this.addHOESlotToContainer(new UniversalSlot((IUniversalInventory) tile,-2,112,37));
