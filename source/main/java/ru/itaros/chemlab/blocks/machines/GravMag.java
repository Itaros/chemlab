...
import ru.itaros.chemlab.client.ui.GravMagContainer;
...
public class GravMag extends IOMachineBlock {
	...
	protected int getUIID() {
		return HOEContainer.getID(GravMagContainer.class);
	}	
	

	public GravMag() {
		super(Material.iron);
		this.setBlockNameRaw("machine."+"gravmag");
