...
import ru.itaros.chemlab.client.ui.FrothCellContainer;
...
public class FrothCell extends IOMachineBlock {
	...
	protected int getUIID() {
		return HOEContainer.getID(FrothCellContainer.class);
	}	
	

	public FrothCell() {
		super(Material.iron);
		this.setBlockNameRaw("machine."+"frothcell");
	...
	protected MachineTileEntity getNewTileEntity() {
		return new FrothCellTileEntity();
	}
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		icons.Register(0, "chemlab", new String[]{"machine_base","machine_base","machine_base","machine_frothcell_face","machine_base","machine_base"}, reg);
	}
