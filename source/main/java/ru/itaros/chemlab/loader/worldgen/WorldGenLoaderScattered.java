...
public class WorldGenLoaderScattered implements IAllowedConfigArgument {
	...
	private static final float NOISEDOWNSAMPLE_ASBESTOS = 0.4F;
	private static final float NOISEDOWNSAMPLE_LIMESTONE = 0.4F;
	private static final float NOISEDOWNSAMPLE_HEMATITE = 0.7F;
	...
	private static GenDistributionProvider scatterer_1;
	private static GenDistributionProvider scatterer_2;
	private static GenDistributionProvider scatterer_3;
	//private static GenDistributionProvider scatterer_4;
	//private static GenDistributionProvider scatterer_5;
	...
	public void execute(){
		...
		scatterer_3 = new GenDistributionProviderScattered(2, 5, 1F, 12, 7278L, 12);
		...
		asbestos_serpentite.setDestributorProvider(scatterer_1);
		registry.registerOverlay(asbestos_serpentite);
		
		hematite=new WorldGenOverlay("hematite", Blocks.stone ,BlockLoader.oreHematite, 15F ,NOISEDOWNSAMPLE_HEMATITE,657L);
		hematite.setDestributorProvider(scatterer_2);
		...
		limestone.setDestributorProvider(scatterer_3);
