...
public class WoodChainRecipes {
	...
	public static void load(){
		...
		IUniversalStack[] incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(Block.getBlockFromName("log2"))});
		IUniversalStack[] outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.woodchips)});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.woodchips)});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.woodchipclump)});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.woodchipclump),new ItemStack(HiVolumeLiquidCell.getByFluid(water))});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.lignocelluloseflakes),new ItemStack(HiVolumeLiquidCell.getByFluid(HOEFluidLoader.cellulosal_extractives_high))});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.emptyhvlc),new ItemStack(ItemLoader.decomposedlignocellulose),new ItemStack(HiVolumeLiquidCell.getByFluid(water))});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(HiVolumeLiquidCell.getByFluid(HOEFluidLoader.wet_cellulose)),new ItemStack(HiVolumeLiquidCell.getByFluid(HOEFluidLoader.wet_lignin))});
		...
		//incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.purelignocelluloseflakes),new ItemStack(HiVolumeLiquidCell.getByFluid(water))});
		incoming = new IUniversalStack[]{new UniversalItemStack(new ItemStack(ItemLoader.purelignocelluloseflakes)),new UniversalFluidStack(water)};
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.impregnatedlignocelluloseflakes),new ItemStack(ItemLoader.emptyhvlc)});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.washedlignocellulose),new ItemStack(HiVolumeLiquidCell.getByFluid(naoh))});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.impregnatedlignocellulose),new ItemStack(ItemLoader.emptyhvlc)});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.impregnatedlignocelluloseflakes)});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.impregnatedwoodfiberspellet)});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.impregnatedlignocellulose)});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.pressedlignocellulose)});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(HiVolumeLiquidCell.getByFluid(water))});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(HiVolumeLiquidCell.getByFluid(steam_pressurized))});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(HiVolumeLiquidCell.getByFluid(steam_pressurized)),new ItemStack(ItemLoader.impregnatedwoodfiberspellet)});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.explodedwoodfibers),new ItemStack(ItemLoader.emptyhvlc)});
		...
		incoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(HiVolumeLiquidCell.getByFluid(steam_pressurized)),new ItemStack(ItemLoader.pressedlignocellulose)});
		outcoming = UniversalStackUtils.convert(new ItemStack[]{new ItemStack(ItemLoader.decomposedlignocellulose),new ItemStack(ItemLoader.emptyhvlc)});
	...
	private static FixedConversionRecipe getRecipeForNativeCrushedGold() {
		...
		IUniversalStack[] i = UniversalStackUtils.convert(new ItemStack[]{OreDictionary.getOres("crushedGold").get(0).copy()});
		IUniversalStack[] o = UniversalStackUtils.convert(new ItemStack[]{goldDust,stoneDust});
	...
	private static FixedConversionRecipe getRecipeForNativeCrushedPyrite() {
		...
		IUniversalStack[] i = UniversalStackUtils.convert(new ItemStack[]{OreDictionary.getOres("crushedPyrite").get(0).copy()});
		IUniversalStack[] o = UniversalStackUtils.convert(new ItemStack[]{pyriteDust,stoneDust});
