...
public class WireCoatingExtruderTileEntity extends MachineCrafterTileEntity {
	...
	public HOEMachineIO getSuperIO() {
		return (HOEMachineCrafterIO) ChemLab.getIOCollection().getHOEIO("WireCoatingExtruderIO");
	}
