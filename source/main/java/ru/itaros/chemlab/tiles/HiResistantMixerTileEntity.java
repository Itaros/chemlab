...
public class HiResistantMixerTileEntity extends MachineCrafterTileEntity {
	...
	public HOEMachineIO getSuperIO() {
		return (HOEMachineCrafterIO) ChemLab.getIOCollection().getHOEIO("HiResistantMixerIO");
	}
