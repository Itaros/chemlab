...
public class MetalFormationMachineTileEntity extends MachineCrafterTileEntity {
	...
	public HOEMachineIO getSuperIO() {
		return (HOEMachineCrafterIO) ChemLab.getIOCollection().getHOEIO("MetalFormationMachineIO");
	}
